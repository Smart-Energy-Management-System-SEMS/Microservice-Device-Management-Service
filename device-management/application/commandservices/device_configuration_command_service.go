...
func (s *DeviceConfigurationCommandService) CreateConfiguration(ctx context.Context, command commands.CreateDeviceConfigurationCommand) (*entities.DeviceConfiguration, error) {
	...
	s.eventHandler.Publish(ctx, s.eventHandler.Topics().DeviceEvents, eventhandlers.EventTypeDeviceConfigurationSaved, configuration.DeviceID, device.UserID, map[string]interface{}{
